...
axis square
colorbar
print('ex1pred3it400','-depsc')

figure(6)
p=plot(x2,trueim(15,:),'r','LineWidth',2.5);
hold on
q=plot(x2,inputim(15,:),'m','LineWidth',2.5);
r=plot(x2,pred1(15,:),':k','LineWidth',1.5);
s=plot(x2,pred2(15,:),'--k','LineWidth',1.5);
t=plot(x2,pred3(15,:),'-k','LineWidth',1.5);
legend([p q r s t],{'True','Calderon','Step 20','Step 40','Step 400'})
ax = gca;
ax.FontSize=15;
set(g,'alphadata',~isnan(trueim));
set(gca,'xtick',[],'xticklabel',[])
hold off
print('ex1cutoff3','-depsc')