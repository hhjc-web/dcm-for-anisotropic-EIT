...
legend([p q r s],{'True','Calderon','Step 20','Step 200'})
ax = gca;
ax.FontSize=15;
set(g,'alphadata',~isnan(trueim));
set(gca,'xtick',[],'xticklabel',[])
hold off
print('ex2cutoff3','-depsc')