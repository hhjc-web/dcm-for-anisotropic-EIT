...
legend([p q r s],{'True','Calderon','Step 100','Step 400'},'Location','south')
ax = gca;
ax.FontSize=15;
set(g,'alphadata',~isnan(trueim));
set(gca,'xtick',[],'xticklabel',[])
hold off
print('ex4cutoff3','-depsc')